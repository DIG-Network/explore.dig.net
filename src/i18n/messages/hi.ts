...
export const hi: PartialMessages = {
  ...
  storeAddressHeading: "इसे सीधे DIG Network से पढ़ें",
  storeAddressIntro: "{name} एक DIG स्टोर के रूप में प्रकाशित है, इसलिए आप इसे वेब के बजाय सीधे नेटवर्क से पढ़ सकते हैं। DIG नोड इंस्टॉल होने पर नीचे दी गई कमांड चलाएँ।",
  storeAddressLabel: "स्टोर पता",
  storeCommandLabel: "कमांड",
  storeUrnLabel: "URN",
  copyAction: "कॉपी करें",
  copyValueLabel: "{label} कॉपी करें",
  copiedStatus: "कॉपी हो गया",
  copyFailedStatus: "कॉपी नहीं हो सका — टेक्स्ट चुनकर स्वयं कॉपी करें।",
  ...
  viewTabsLabel: "व्यू बदलें",
  storeTabLabel: "स्टोर",
  appsTabLabel: "ऐप्स",
  appsPageHeading: "ऐप्स",
  appsPageIntro: "DIG Network का हर dApp, बस एक टैप दूर — आपके फ़ोन की होम स्क्रीन की तरह।",
  appsGridLabel: "DIG Network ऐप्स",
  viewDetailsFor: "{name} का विवरण देखें",
};
